...
def train_simpleRNN_model(x_train, x_test, y_train, y_test, model_filename='simpleRNN.keras', plot_filename='training_lost.png', epochs=50, batch_size=2):
...
def main():
    # Load data from CSV
    x_train = pd.read_csv("corrosion_x_train_ecfp_shuffled.csv",index_col=0)
    x_test = pd.read_csv("corrosion_x_test_ecfp_shuffled.csv",index_col=0)
