...
def main():
    # Load data from CSV
    x_train = pd.read_csv("corrosion_x_train_token_descriptors_shuffled.csv",index_col=0)
    x_test = pd.read_csv("corrosion_x_test_token_descriptors_shuffled.csv",index_col=0)
