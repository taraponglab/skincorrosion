...
def train_simpleRNN_model(x_train, x_test, y_train, y_test, model_filename='simpleRNN.keras', epochs=50, batch_size=2):
    ...
    # Reshape data for simpleRNN: (samples, timesteps, features)
